...
import com.study.danketools.fragment.components.paint.shader.view.DKRadialGradientView;
...
@Widget(name = "RadialGradient环形渲染")
public class DKRadialGradientFragment extends BaseFragment {
    @BindView(R.id.topbar)
    QMUITopBarLayout mTopBar;
    @BindView(R.id.view)
    DKRadialGradientView view;
    ...
    protected View onCreateView() {
        View root = LayoutInflater.from(getContext()).inflate(R.layout.fragment_radial_gradient, null);
